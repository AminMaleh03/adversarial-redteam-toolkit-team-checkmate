...
SOURCES = [
    ...
    ("emotion_oces_analysis", "artifacts/oces_baseline_link_v1/emotion.analysis.json",
     "real", "emotion.oces", "F", "Corrected OCES baseline association, reanalysed from preserved real emotion responses (schema v3)."),
    ("emotion_oces_provenance", "artifacts/oces_baseline_link_v1/PROVENANCE.md",
     "real", "emotion.oces", "F", "Provenance of the OCES scoring correction; original inference and evidence preserved."),
    ...
    ("sentiment_oces_analysis", "artifacts/oces_baseline_link_v1/sentiment.analysis.json",
     "real", "sentiment.oces", "F", "Corrected OCES baseline association, reanalysed from preserved real sentiment responses (schema v3)."),
    ("sentiment_oces_provenance", "artifacts/oces_baseline_link_v1/PROVENANCE.md",
     "real", "sentiment.oces", "F", "Provenance of the OCES scoring correction; original inference and evidence preserved."),
